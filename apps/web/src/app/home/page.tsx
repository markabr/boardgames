      ...
      <div className="max-w-5xl mx-auto px-6 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {GAMES.map((game) => (
            <div
              key={game.id}
              className="p-6 rounded-xl bg-gray-800/50 border border-gray-700 hover:border-amber-600/50 transition-all group cursor-pointer"
            >
              ...
              <div className="mt-4 flex gap-2">
                <button className="flex-1 px-3 py-2 bg-amber-600 hover:bg-amber-500 text-white text-sm font-semibold rounded-lg transition-colors">
                  Create Lobby
                </button>
                <button className="flex-1 px-3 py-2 border border-gray-600 hover:border-gray-400 text-gray-300 text-sm font-semibold rounded-lg transition-colors">
                  Quick Play
                </button>
              </div>
            </div>
